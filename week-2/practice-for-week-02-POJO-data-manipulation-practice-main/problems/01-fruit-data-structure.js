...
//GAMEPLAN
//non-tech solution:
//pick the first fruit you see
//tech solution:
//must return 'genus: Malus' kvp
//for in single pringle
//NEVERMIND ALL I NEEDED WAS TO RETURN THE WHOLE OBJECT AND ONE-LINE IT LOOOOOOOL

const firstFruitObject = fruits => fruits[0];
...
//GAMEPLAN: repeat w/ last object

const lastFruitObject = fruits => fruits[5];
...
let indexFruitObject(index, fruits) {
    // Your code here
}
